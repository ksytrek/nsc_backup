                        ...
                        <div class="login-form">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#personnel" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">สำหรับบุคลากร</span></a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#admin" role="tab"><span class="hidden-sm-up"><i class="ti-headphone-alt"></i></span> <span class="hidden-xs-down">สำหรับผู้ดูแลระบบ</span></a> </li>
                                </ul>
                                <!-- Tab panes -->
                                    ...
                                    <div class="tab-pane active" id="personnel" role="tabpanel">
                                        <div class="p-20">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" id="rememberMe_per" onclick="lsRememberMe()"> จดจำไว้
                                                    </label>
                                                ...
                                                <button id="submit_per" onclick="send_submit_per('submit_per')" type="button" class="btn btn-primary btn-flat m-b-30 m-t-30">เข้าสู่ระบบ</button>

                                                <div class="register-link m-t-15 text-center">
                                                    <p>ไม่มีบัญชี ? <a href="./register.php"> ลงทะเบียนที่นี่ </a></p>
                                                </div>
                                    ...
                                    <div class="tab-pane" id="admin" role="tabpanel">
                                        <div class="p-20">
                                            ...
                                            <form action="./admin/dashboard_ad.php" method="post">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input id="rememberMe_ad" type="checkbox" onclick="lsRememberMe_ad()"> จดจำไว้
                                                    </label>
                                                    <label class="pull-right">
                                                        <!-- <a href="#">Forgotten Password?</a> -->
                                                    </label>
                                                ...
                                                <button id="submit_ad" onclick="send_submit_ad('submit_ad')" type="button" class="btn btn-primary btn-flat m-b-30 m-t-30">เข้าสู่ระบบ</button>
                                                <!-- <div class="register-link m-t-15 text-center">
