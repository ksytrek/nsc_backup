...
<body>
    ...
    <div class="container">
        ...
        <table border="0" align="center" cellspacing="1" class="display" id="example">
            ...
            $query = "SELECT schedule.std_code , rooms.room_num , schedule.time_stamp FROM schedule INNER JOIN rooms ON schedule.room_code = rooms.room_code  WHERE time_stamp BETWEEN '2020-01-01' AND '2021-12-31' ORDER BY schedule.time_stamp ASC";
            //ประกาศตัวแปร sqli
