...
$check = $connectDB->prepare("SELECT `name_ad`,`e_mail_ad` FROM `tbadmin` WHERE `id_admin`='$i_code'");
$check->execute();
...
<body>
    ...
    <nav class="l-sidenav bg-light">
        <div class="card bg-primary">
            ...
            <!-- Image Profile -->
                <img src="<?php echo _IMAGE."profiledefined.png" ?>" class="rounded-circle" style="width:70px;height:90px;">
                <h6 class="card-title"><?php echo $row['name_ad'] ;?></h6>
                <p class="card-text">
                    <!-- <?php echo $row['e_mail_ad']?> -->
                </p>
            </div>
        </div>
        <!-- เมนูแบบที่ 1 -->
        ...
        <ul class="list-group list-group-flush">
            <li  class="list-group-item"><a style="margin-left:0px;" class="link link-secondary  " href="<?PHP echo _ADMIN ?>">หน้าหลัก</a></li>
            <li  class="list-group-item "><a style="margin-left:0px;" class="link link-secondary  "href="<?PHP echo _ROOM_MANAGEMENY."room_management.php" ?>" >จัดการห้อง</a></li>
    ...
    <nav class="navbar navbar-light bg-primary fixed-top">
        ...
        <!--  ส่วนแสดงชื่อโปรเจ็ค หรือหัวข้อที่ต้องการ อยุ่ตรงกลางจอ-->
            <a class="navbar-brand" href="./">จัดการข้อมูลห้อง</a>
